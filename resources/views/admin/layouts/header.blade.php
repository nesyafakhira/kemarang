                                ...
                                <div class="card-body p-0">
                                    <a href="{{ url("#") }}" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="{{ asset("assets/admin/images/shapes/01.png") }}" alt="">
                                    ...
                                    <a href="{{ url("#") }}" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="{{ asset("assets/admin/images/shapes/02.png") }}" alt="">
                                            </div>
                                            <div class="ms-3 w-100">
                                    ...
                                    <a href="{{ url("#") }}" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="{{ asset("assets/admin/images/shapes/03.png") }}" alt="">
                                            <div class="ms-3 w-100">
                                    ...
                                    <a href="{{ url("#") }}" class="iq-sub-card">
                                        <div class="d-flex align-items-center">
                                            <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="{{ asset("assets/admin/images/shapes/04.png") }}" alt="">
