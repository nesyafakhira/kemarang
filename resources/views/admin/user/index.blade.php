                                ...
                                <table id="user-table" class="table" role="grid">
                                    ...
                                    <tbody>
                                        @foreach ($kepsek as $kepsek)
                                            ...
                                            <tr>
                                                <td>{{ $kepsek->name }}</td>
                                                <td>{{ $kepsek->nip_nikki }}</td>
                                                <td>{{ $kepsek->email }}</td>
                                                <td>
                                                    <span class="badge bg-primary">Kepala Sekolah</span>
                                                </td>
                                                <td>{{ $kepsek->created_at->formatLocalized('%d %B %Y') }}</td>
                                                <td>
                                                    <form action="{{ route('user.destroy', $kepsek->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        ...
                                                        <div class="flex align-items-center list-user-action">
                                                            <a class="btn btn-sm btn-icon btn-info" data-toggle="tooltip"
                                                                ...
                                                                href="{{ route('user.show', [$kepsek->id]) }}">
                                                            ...
                                                            <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip"
                                                                ...
                                                                href="{{ route('user.edit', [$kepsek->id]) }}">
                                                                <span class="btn-inner">
