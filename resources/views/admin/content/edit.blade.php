                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="new-user-info">
                            <form action="{{ route('content.update', $request->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12">
                                        <label class="form-label" id="labelRequest" for="mobno">Jumlah Content Unit</label>
