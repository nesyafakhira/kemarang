...
if (jQuery("#basic-column-chart").length) {
    var options = {
        series: [{
        name: '',
        ...
        name: '',
        data: [81, 115, 70, 98, 70, 105, 91, 114, 94]
      }, 
    ],
        chart: {
        type: 'bar',
      ...
      var chart = new ApexCharts(document.querySelector("#basic-column-chart"), options);
      chart.render();
}
